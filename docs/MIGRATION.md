...
- Установленные зависимости проекта (`pip install -r api/requirements.txt`)
...
Но в этом репозитории базовый и поддерживаемый путь — `api/scripts/migrate_sqlite_to_postgres.py`.
